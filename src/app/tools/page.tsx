...
export const metadata: Metadata = {
  title: "無料ツール一覧｜PDF変換・履歴書・職務経歴書・ES作成",
  description:
    "ディビゼロの無料ツール一覧。PDF変換、履歴書・職務経歴書ビルダー、エントリーシート作成ツール。インストール不要・個人情報の送信なし。",
  keywords: [
    "無料 PDF変換",
    "無料 履歴書",
    "無料 職務経歴書",
  ...
  openGraph: {
    ...
    title: "無料ツール一覧｜PDF変換・履歴書・職務経歴書・ES作成",
    description:
      "ディビゼロの無料ツール一覧。PDF変換・履歴書・職務経歴書・エントリーシート作成。ブラウザ内処理で個人情報の送信なし。",
  },
  twitter: {
